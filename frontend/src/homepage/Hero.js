...
export default function Hero() {
  ...
  <div class="container px-5 pl-10 py-2 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/6 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      ...
      <button onClick={()=>navigate('/register')} type="button" class="text-white bg-[#fb9e55] hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-6 mt-16 py-4 text-center mr-3">Get Register Now</button>
    </div>
